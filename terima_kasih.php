...
<head>
    ...
    <!-- Style untuk tampilan halaman terima kasih-->
    <style>
        body {
            margin: 0;
            padding: 0;
        ...
        /* Hamburger menu icon di kanan atas */
        .hamburger-icon {
            position: absolute;
            top: 35px;
            right: 30px;
        ...
        /* Dropdown menu saat hamburger diklik */
        .dropdown-content {
            display: none;
            position: absolute;
            top: 70px;
...
<body>
    <!-- Bagian utama halaman terima kasih -->
    ...
    <!-- Script untuk toggle dropdown hamburger -->
    <script>
        ...
        // Menutup dropdown jika klik di luar hamburger
